...
class ImportInventoryTestCase(TestCase):
    ...
    def test_bad_header_csv(self, mock_success):
        ...
        self.assertEqual(
            'Header mismatch for "bad_header.csv"', response.context_data['form'].errors['file'].data[0].message.args[0]
        )
    ...
    def test_no_inventory_tab_ods(self, mock_success):
        ...
        self.assertEqual(
            'Inventory tab not found in "no_inventory_tab.ods"',
    ...
    def test_bad_header_ods(self, mock_success):
        ...
        self.assertEqual(
            'Header mismatch for "bad_header.ods" on the Inventory tab',
            response.context_data['form'].errors['file'].data[0].message.args[0]
        )
