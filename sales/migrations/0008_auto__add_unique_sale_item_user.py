...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Sale', fields ['item', 'user']
        db.create_unique(u'sales_sale', ['item_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Sale', fields ['item', 'user']
        db.delete_unique(u'sales_sale', ['item_id', 'user_id'])
