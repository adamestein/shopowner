...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Tax', fields ['county', 'state']
        db.create_unique(u'sales_tax', ['county', 'state'])


    def backwards(self, orm):
        # Removing unique constraint on 'Tax', fields ['county', 'state']
        db.delete_unique(u'sales_tax', ['county', 'state'])
