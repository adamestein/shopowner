...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sale.date'
        db.alter_column(u'sales_sale', 'date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Sale.date'
        db.alter_column(u'sales_sale', 'date', self.gf('django.db.models.fields.DateField')(default=None))
    ...
    models = {
        ...
        u'sales.sale': {
            'Meta': {'ordering': "('date', 'item__desc')", 'unique_together': "(('item', 'user'),)", 'object_name': 'Sale'},
