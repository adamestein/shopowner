...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sale.item'
        db.add_column(u'sales_sale', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['inventory.Item']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sale.item'
        db.delete_column(u'sales_sale', 'item_id')
