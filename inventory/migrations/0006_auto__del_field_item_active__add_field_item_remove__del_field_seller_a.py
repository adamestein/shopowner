...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.remove'
        db.add_column(u'inventory_item', 'remove',
        ...
        # Adding field 'Seller.remove'
        db.add_column(u'inventory_seller', 'remove',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Item.remove'
        db.delete_column(u'inventory_item', 'remove')
        ...
        # Deleting field 'Seller.remove'
        db.delete_column(u'inventory_seller', 'remove')
