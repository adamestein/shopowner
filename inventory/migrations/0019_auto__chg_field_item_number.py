...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.number'
        db.alter_column(u'inventory_item', 'number', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Item.number'
        db.alter_column(u'inventory_item', 'number', self.gf('django.db.models.fields.CharField')(max_length=5))
