...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.desc'
        db.add_column(u'inventory_category', 'desc',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.desc'
        db.delete_column(u'inventory_category', 'desc')
    ...
    models = {
        ...
        u'inventory.item': {
            ...
            'category': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['inventory.Category']", 'symmetrical': 'False'}),
            ...
            'remove': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'seller': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['inventory.Seller']", 'symmetrical': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
