...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'inventory_constant', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tax_rate', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'inventory', ['Constant'])

        # Adding field 'Item.comments'
        db.add_column(u'inventory_item', 'comments',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'inventory_constant')

        # Deleting field 'Item.comments'
        db.delete_column(u'inventory_item', 'comments')
