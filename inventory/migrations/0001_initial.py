...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'inventory_item', (
            ...
            ('sale_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True)),
            ('sale_date', self.gf('django.db.models.fields.DateField')(db_index=True, null=True, blank=True)),
            ('removed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'inventory', ['Item'])

        # Adding unique constraint on 'Item', fields ['user', 'number']
        db.create_unique(u'inventory_item', ['user_id', 'number'])

        # Adding M2M table for field owner on 'Item'
        m2m_table_name = db.shorten_name(u'inventory_item_owner')
        ...
        # Adding model 'Seller'
        db.create_table(u'inventory_seller', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'inventory', ['Seller'])


    def backwards(self, orm):
        # Removing unique constraint on 'Item', fields ['user', 'number']
        db.delete_unique(u'inventory_item', ['user_id', 'number'])

        # Deleting model 'Item'
        db.delete_table(u'inventory_item')

        # Removing M2M table for field owner on 'Item'
        db.delete_table(db.shorten_name(u'inventory_item_owner'))

        # Deleting model 'Seller'
        db.delete_table(u'inventory_seller')
    ...
    models = {
        ...
        u'inventory.item': {
            ...
            'sale_date': ('django.db.models.fields.DateField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
