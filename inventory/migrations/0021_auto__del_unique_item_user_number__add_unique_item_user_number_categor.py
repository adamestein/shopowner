...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Item', fields ['user', 'number', 'category']
        db.create_unique(u'inventory_item', ['user_id', 'number', 'category_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Item', fields ['user', 'number', 'category']
        db.delete_unique(u'inventory_item', ['user_id', 'number', 'category_id'])
    ...
    models = {
        ...
        u'inventory.item': {
            'Meta': {'ordering': "('number',)", 'unique_together': "(('user', 'number', 'category'),)", 'object_name': 'Item'},
