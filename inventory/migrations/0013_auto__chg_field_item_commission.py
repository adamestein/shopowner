...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'inventory_item', 'commission', self.gf('django.db.models.fields.CharField')(max_length=5))

    def backwards(self, orm):

        # Changing field 'Item.commission'
        db.alter_column(u'inventory_item', 'commission', self.gf('django.db.models.fields.FloatField')())
